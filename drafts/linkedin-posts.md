...
The honest bit: "transparent and ethical AI use" is easy to say and genuinely hard to do in a live unit. Some of it I got wrong before I got it right.

→ bigpicture.borck.dev

#AIinEducation #CurriculumDesign #HigherEd
...
#LocalAI #AIResearch #PrivacyByDesign

---

## 3 · Tools for students

"I'd love to recommend AI to my students. I just can't recommend sending their data to a cloud I don't control."

So I built small apps that don't ask you to: each does one job, runs on the student's own laptop, and keeps their data on the device.

Rehearse a hard conversation before you have it. A tutor that makes you *argue* for the answer instead of handing it over. Career exploration where the résumé never leaves the machine.

Free, private, and recommendable.

→ bigpicture.borck.dev

#EdTech #StudentSuccess #PrivacyFirst
...
#LearningAndTeaching #AIinEducation #AssessmentDesign

---

## 5 · Assessment at scale

Two things are true at once: marking a large cohort fairly is exhausting, and handing the marking to AI is a line most of us don't want to cross. Rightly.
...
#Assessment #AIinEducation #AcademicIntegrity
...
#DataGovernance #LocalAI #HigherEd

---

## 7 · The role

For a year I was my school's first embedded *AI Facilitator*. Here's the honest account of what that actually turned out to be.
...
#AILiteracy #HigherEd #ProfessionalDevelopment
...
#BuildInPublic #AItools #SoftwareDevelopment
...
#WritingWithAI #Authorship #AIinEducation
...
#WorkIntegratedLearning #Simulation #Employability
